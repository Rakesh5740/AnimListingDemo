...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final Adapterdelegates4LibraryAccessors laccForAdapterdelegates4LibraryAccessors = new Adapterdelegates4LibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>adapterdelegates4</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Adapterdelegates4LibraryAccessors getAdapterdelegates4() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAdapterdelegates4LibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class Adapterdelegates4LibraryAccessors extends SubDependencyFactory {
        private final Adapterdelegates4KotlinLibraryAccessors laccForAdapterdelegates4KotlinLibraryAccessors = new Adapterdelegates4KotlinLibraryAccessors(owner);

        public Adapterdelegates4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>adapterdelegates4.kotlin</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Adapterdelegates4KotlinLibraryAccessors getKotlin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAdapterdelegates4KotlinLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Adapterdelegates4KotlinLibraryAccessors extends SubDependencyFactory {
        private final Adapterdelegates4KotlinDslLibraryAccessors laccForAdapterdelegates4KotlinDslLibraryAccessors = new Adapterdelegates4KotlinDslLibraryAccessors(owner);

        public Adapterdelegates4KotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>adapterdelegates4.kotlin.dsl</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Adapterdelegates4KotlinDslLibraryAccessors getDsl() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAdapterdelegates4KotlinDslLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Adapterdelegates4KotlinDslLibraryAccessors extends SubDependencyFactory {

        public Adapterdelegates4KotlinDslLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         * with version reference <b>adapterdelegates4KotlinDslViewbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getViewbinding() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("adapterdelegates4.kotlin.dsl.viewbinding");
        }
    ...
    public static class AndroidxAppcompatLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110alpha04</b> with <b>androidx.appcompat:appcompat</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV110alpha04() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.appcompat.v110alpha04");
        }
    ...
    public static class AndroidxFragmentKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110</b> with <b>androidx.fragment:fragment-ktx</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV110() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.fragment.ktx.v110");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adapterdelegates4KotlinDslViewbinding</b> with value <b>4.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAdapterdelegates4KotlinDslViewbinding() { return getVersion("adapterdelegates4KotlinDslViewbinding"); }
        ...
        /**
         * Version alias <b>appcompatVersion</b> with value <b>1.1.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>fragmentKtx</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>fragmentKtxVersion</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>glide</b> with value <b>4.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleExtensions</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
